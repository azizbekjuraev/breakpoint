...
When you write `setTimeout(counter.increment, 10)`, you're passing the function *value* to setTimeout. Later, when setTimeout calls it, how is it being called — as `counter.increment()`, or as a plain function?
